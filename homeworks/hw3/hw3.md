...
due_date: 2026-05-26 23:59:00
materials:
   -
      name: hw3-aidm.ipynb
      url: https://github.com/pearls-lab/deep-rl-course-SP26/tree/main/homeworks/hw3/hw3-aidm.ipynb
...
the [Kani library](https://kani.readthedocs.io/en/latest/), function calling with LLMs, and how LLMs can use structured
...
- Your Triton AI API key or [OpenAI API key](https://platform.openai.com/api-keys)
...
To run this code in your Python IDE, you'll need to install a couple of Python packages via `pip`, and you'll need to set
...
If you're using VS Code, you can pass your `OPENAI_API_KEY` to it when you launch it from
the command line:
...
Replace `sk-helicone-XXXXXXX-XXXXXX` with your Triton AI API key (or OpenAI API key, which you can
